...
async def test_chat_endpoint_with_mock(mock_process, client: AsyncClient, auth_headers: dict):
...
@pytest.mark.asyncio
async def test_chat_endpoint_missing_fields(client: AsyncClient, auth_headers: dict):
...
@pytest.mark.asyncio
async def test_models_endpoint(client: AsyncClient, auth_headers: dict):
