...
MANAGER_PROMPT = """You are the Senior Legal Interface for a UK government legal department.
...
WORKER_PROMPT = """You are a specialized Legal Research Support Agent for UK Law.
...
DEEP_RESEARCH_PROMPT = """You are a Deep Research Agent.
