          ...
          <div className="rounded-lg bg-accent-soft border border-accent/30 px-6 py-5 space-y-5">
            ...
            <div className="text-center pb-1 border-b border-accent/20">
              ...
              <p className="font-ui text-sm text-ink-700 leading-relaxed">
                {botName} is a proof-of-concept system under active development. It is not yet approved for
                production use. Outputs should be treated as indicative only and verified before being relied upon.
              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-ui text-sm text-ink-700 leading-relaxed">
                  {botName} currently routes queries through large language model (LLM) services hosted by
                  third-party providers outside this organisation's secure network. Text entered into this tool
                  may be transmitted to and processed by those external services.
                </p>
              </div>
            </div>
            ...
            {/* Prohibited content */}
            <div>
              <h2 className="font-ui text-sm font-semibold text-ink-900 mb-2">
                Information You Must Not Enter
              </h2>
              <p className="font-ui text-sm text-ink-700 leading-relaxed mb-3">
                In accordance with your data-handling obligations and organisational security policy, you must
                not enter any of the following into this tool:
              </p>
            ...
            <div>
              ...
              <p className="font-ui text-sm text-ink-700 leading-relaxed">
                {botName} is suitable for general legal research using publicly available UK legislation and
                case law. Queries should be framed in general, hypothetical, or anonymised terms. It must not
                be used as a substitute for independent legal advice or judgment on a specific matter.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="font-ui text-sm text-ink-700 leading-relaxed">
                All queries and responses are logged and may be reviewed for security, compliance, and
                quality-assurance purposes. Do not assume that any query is private.
              </p>
            </div>
