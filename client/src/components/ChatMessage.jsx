    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
          <div style={{ fontSize: 15, fontWeight: 600, color: 'var(--ink-900)' }}>What went wrong?</div>
          <button
            onClick={onCancel}
        ...
        <textarea
          ...
          onBlur={e => {
            e.target.style.borderColor = 'var(--ink-300)';
          }}
        />
...
function ConfirmModal({ message, confirmLabel, onConfirm, onCancel }) {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ fontSize: 15, fontWeight: 600, color: 'var(--ink-900)', marginBottom: 10 }}>Change rating?</div>
        <p style={{ fontSize: 13, color: 'var(--ink-500)', lineHeight: 1.5, marginBottom: 20 }}>{message}</p>
    ...
    try {
      ...
      await navigator.clipboard.write([
        new ClipboardItem({
          ...
          'text/plain': new Blob([processedContent], { type: 'text/plain' }),
        }),
      ]);
    } catch {
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            <ToolBtn
              ...
              onClick={() => {
                if (rating !== 1) setShowThumbsDownForm(v => !v);
              }}
            >
              <svg
                width={15}
