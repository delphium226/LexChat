      ...
      >
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 }}>
          <div style={{ flex: 1 }}>
            ...
            {status === 'success' ? (
              <div style={{ fontSize: 13, color: 'var(--ink-600)', paddingTop: 4 }}>Thank you for your feedback!</div>
            ) : (
              <>
                {/* Q1: Time without AILA */}
                <div style={{ marginBottom: 14 }}>
                  <label style={labelStyle}>
                    Think about the tasks you used the AI assistant for this past week. If you had to complete those
                    exact same tasks manually, approximately how much total time would it have taken you? (hours)
                  </label>
                  <input
                    type="number"
                    min="0"
                ...
                <div style={{ marginBottom: 14 }}>
                  <label style={labelStyle}>
                    By using the AI assistant for those tasks, how much time do you estimate you actively saved this
                    week? (hours)
                  </label>
                  <input
                    type="number"
                  ...
                  <div style={{ display: 'flex', gap: 6 }}>
                    {[1, 2, 3, 4, 5].map(n => (
                      <button
                        ...
                        disabled={status === 'submitting'}
                        title={
                          ['Very difficult', 'Difficult', 'Neither easy nor difficult', 'Easy', 'Very easy'][n - 1]
                        }
                        style={{
                          width: 32,
                          height: 32,
