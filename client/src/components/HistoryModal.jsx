      ...
      <div className="px-4 pt-3 pb-1">
        <div className="relative">
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-ink-400 pointer-events-none"
          >
            <path
              strokeLinecap="round"
              ...
              >
                <div className="flex-1 min-w-0 pr-2">
                  {editingId === chat.id ? (
                    ...
                    <div>
                      <div className="font-medium text-ink-900 truncate">{chat.title}</div>
                      <div className="text-xs text-ink-500">{new Date(chat.created_at).toLocaleString()}</div>
                    </div>
                  )}
                </div>
